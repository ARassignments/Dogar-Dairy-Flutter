...
class PaymentMethodNotifier extends StateNotifier<List<PaymentDropdownModel>> {
  PaymentMethodNotifier() : super(_defaultPaymentMethods());

  static List<PaymentDropdownModel> _defaultPaymentMethods() {
    return [
  ...
  void togglePaymentMethod(String name) {
...
final paymentMethodProvider =
    StateNotifierProvider<PaymentMethodNotifier, List<PaymentDropdownModel>>(
