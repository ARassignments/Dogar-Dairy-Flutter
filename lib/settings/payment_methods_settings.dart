...
class PaymentMethodsSettingsScreen extends ConsumerStatefulWidget {
  const PaymentMethodsSettingsScreen({super.key});

  @override
  ConsumerState<PaymentMethodsSettingsScreen> createState() =>
      _PaymentMethodsSettingsScreenState();
}

class _PaymentMethodsSettingsScreenState
    extends ConsumerState<PaymentMethodsSettingsScreen> {
  @override
  Widget build(BuildContext context) {
    final paymentTypes = ref.watch(paymentMethodProvider);
    return Scaffold(
      appBar: AppBar(
